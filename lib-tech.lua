...
---@param science_pack string Название научного пакета
---@param amount int Количество (по умолчанию 1)
-- ----------------------------------------------------------------------------------------------
...
---@param tech_name string Название технологии
---@param science_pack string Название научного пакета
---@param remove_all boolean Полностью удалить (true) или уменьшить количество (false)
---@param amount int Количество для удаления (по умолчанию 1)
-- ----------------------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------------------
---@param tech_name string Название технологии
---@param old_pack string Название заменяемого пакета
---@param new_pack string Название нового пакета
---@param new_amount int Количество нового пакета (nil = сохранить старое количество)
-- ----------------------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------------------
---@param tech_name string Название технологии
---@param new_ingredients table Таблица новых ингредиентов в формате {{"pack1", amount}, {"pack2", amount}}
-- ----------------------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------------------
---@param tech_name string Название технологии
---@return table|nil 'Таблица пакетов (может быть пустой) или nil если технология не найдена'
-- ----------------------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------------------------
---@param tech_name string Название технологии
---@return table|nil 'Таблица рецептов или nil'
-- ----------------------------------------------------------------------------------------------
