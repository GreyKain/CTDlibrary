...
-- ----------------------------------------------------------------------------------------------
---@param ingredient string|table   примеры: "coal" или {"coal", 1} или {type = "item", name = "coal", amount = 1}
...
---@param new_ingredient string|table   примеры: "coal" или {"coal", 1} или {type = "item", name = "coal", amount = 1}
-- ----------------------------------------------------------------------------------------------
...
-- ##############################################################################################
    -- ДОБАВЛЕНИЕ ПРЕДМЕТА В РЕЗУЛЬТАТЫ РЕЦЕПТА
-- ----------------------------------------------------------------------------------------------
---@param recipe_name string                Идентификатор рецепта
---@param new_item string                   Идентификатор результата
---@param amount int                        Кол-во результата
...
---@param new_amount int                    Новое кол-во
